    ...
    <div className="min-h-screen bg-[#07080a] flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            href="/blog"
            className="inline-flex items-center justify-center px-6 py-3 rounded-xl border border-zinc-700 text-zinc-300 font-semibold hover:border-zinc-500 transition-colors"
          >
            Read the Blog
          </Link>
        </div>
