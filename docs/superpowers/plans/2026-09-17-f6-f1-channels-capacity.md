...
5. Set `HETZNER_LOCATIONS=xyz1` locally and deploy as staff → after ~40 s, toast "Sin servidores disponibles ahora mismo." with a Reintentar button; response is 503 with `Retry-After: 120`.
